...
st.markdown(link)
st.write('ティッカーシンボルについては上のリンク（SBI証券）をご参加ください。')
...
try:
    ...
    st.header(stock_name + "終値と14日間平均")
    ...
    st.header(stock_name + '１か月後を予測しましょう(USD)')
    def stock_predict():
...
st.write('Copyright © 2021 Kim SungSik. All Rights Reserved.')
